...
var self__ = this;
var this$ = this;
var x_SINGLEQUOTE__10545 = cljs.core.vary_meta.call(null,x,cljs.core.assoc,new cljs.core.Keyword(null,"client-time","client-time",-1212214195),(new Date()));
if((self__.size <= self__.arr.length)){
var id_SINGLEQUOTE__10546 = self__.arr.shift();
cljs.core.swap_BANG_.call(null,self__.index,((function (id_SINGLEQUOTE__10546,x_SINGLEQUOTE__10545,this$){
return (function (p1__10542_SHARP_){
return cljs.core.assoc.call(null,cljs.core.dissoc.call(null,p1__10542_SHARP_,id_SINGLEQUOTE__10546),id,x_SINGLEQUOTE__10545);
});})(id_SINGLEQUOTE__10546,x_SINGLEQUOTE__10545,this$))
);
} else {
cljs.core.swap_BANG_.call(null,self__.index,cljs.core.assoc,id,x_SINGLEQUOTE__10545);
}
...
om.next.cache.Cache.cljs$lang$ctorPrWriter = (function (this__8770__auto__,writer__8771__auto__,opt__8772__auto__){
return cljs.core._write.call(null,writer__8771__auto__,"om.next.cache/Cache");
});
