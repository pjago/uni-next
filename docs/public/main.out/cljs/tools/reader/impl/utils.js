...
cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__8787__auto__,k10611,else__8788__auto__){
var self__ = this;
var this__8787__auto____$1 = this;
var G__10614 = k10611;
var G__10614__$1 = (((G__10614 instanceof cljs.core.Keyword))?G__10614.fqn:null);
switch (G__10614__$1) {
case "splicing?":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k10611,else__8788__auto__);
...
cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__10610){
var self__ = this;
var G__10610__$1 = this;
return (new cljs.core.RecordIter((0),G__10610__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),new cljs.core.Keyword(null,"form","form",-1624062471)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__8792__auto__,k__8793__auto__,G__10610){
var self__ = this;
var this__8792__auto____$1 = this;
var pred__10615 = cljs.core.keyword_identical_QMARK_;
var expr__10616 = k__8793__auto__;
if(cljs.core.truth_(pred__10615.call(null,new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),expr__10616))){
return (new cljs.tools.reader.impl.utils.ReaderConditional(G__10610,self__.form,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__10615.call(null,new cljs.core.Keyword(null,"form","form",-1624062471),expr__10616))){
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,G__10610,self__.__meta,self__.__extmap,null));
} else {
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,self__.form,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__8793__auto__,G__10610),null));
}
}
});
...
cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__8784__auto__,G__10610){
var self__ = this;
var this__8784__auto____$1 = this;
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,self__.form,G__10610,self__.__extmap,self__.__hash));
});
...
cljs.tools.reader.impl.utils.map__GT_ReaderConditional = (function cljs$tools$reader$impl$utils$map__GT_ReaderConditional(G__10612){
return (new cljs.tools.reader.impl.utils.ReaderConditional(new cljs.core.Keyword(null,"splicing?","splicing?",-428596366).cljs$core$IFn$_invoke$arity$1(G__10612),new cljs.core.Keyword(null,"form","form",-1624062471).cljs$core$IFn$_invoke$arity$1(G__10612),null,cljs.core.dissoc.call(null,G__10612,new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),new cljs.core.Keyword(null,"form","form",-1624062471)),null));
});
...
var iter__8972__auto__ = (function cljs$tools$reader$impl$utils$namespace_keys_$_iter__10891(s__10892){
return (new cljs.core.LazySeq(null,(function (){
var s__10892__$1 = s__10892;
while(true){
var temp__5278__auto__ = cljs.core.seq.call(null,s__10892__$1);
if(temp__5278__auto__){
var s__10892__$2 = temp__5278__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__10892__$2)){
var c__8970__auto__ = cljs.core.chunk_first.call(null,s__10892__$2);
var size__8971__auto__ = cljs.core.count.call(null,c__8970__auto__);
var b__10894 = cljs.core.chunk_buffer.call(null,size__8971__auto__);
if((function (){var i__10893 = (0);
while(true){
if((i__10893 < size__8971__auto__)){
var key = cljs.core._nth.call(null,c__8970__auto__,i__10893);
cljs.core.chunk_append.call(null,b__10894,((((key instanceof cljs.core.Symbol)) || ((key instanceof cljs.core.Keyword)))?(function (){var vec__10972 = cljs.core.juxt.call(null,cljs.core.namespace,cljs.core.name).call(null,key);
var key_ns = cljs.core.nth.call(null,vec__10972,(0),null);
var key_name = cljs.core.nth.call(null,vec__10972,(1),null);
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__10894),cljs$tools$reader$impl$utils$namespace_keys_$_iter__10891.call(null,cljs.core.chunk_rest.call(null,s__10892__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__10894),null);
}
} else {
var key = cljs.core.first.call(null,s__10892__$2);
return cljs.core.cons.call(null,((((key instanceof cljs.core.Symbol)) || ((key instanceof cljs.core.Keyword)))?(function (){var vec__10975 = cljs.core.juxt.call(null,cljs.core.namespace,cljs.core.name).call(null,key);
var key_ns = cljs.core.nth.call(null,vec__10975,(0),null);
var key_name = cljs.core.nth.call(null,vec__10975,(1),null);
var __GT_key = (((key instanceof cljs.core.Symbol))?cljs.core.symbol:cljs.core.keyword);
if((key_ns == null)){
return __GT_key.call(null,ns,key_name);
} else {
...
})():key),cljs$tools$reader$impl$utils$namespace_keys_$_iter__10891.call(null,cljs.core.rest.call(null,s__10892__$2)));
}
} else {
return null;
}
...
cljs.tools.reader.impl.utils.second_SINGLEQUOTE_ = (function cljs$tools$reader$impl$utils$second_SINGLEQUOTE_(p__11020){
var vec__11027 = p__11020;
var a = cljs.core.nth.call(null,vec__11027,(0),null);
var b = cljs.core.nth.call(null,vec__11027,(1),null);
