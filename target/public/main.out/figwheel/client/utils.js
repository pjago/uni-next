...
return (new CustomEvent(event_name,(function (){var obj23908 = {"detail":data};
return obj23908;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__8098__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__8098__auto__)){
var and__8098__auto____$1 = (window["CustomEvent"]);
...
var args23913 = [];
var len__9331__auto___23919 = arguments.length;
var i__9332__auto___23920 = (0);
while(true){
if((i__9332__auto___23920 < len__9331__auto___23919)){
args23913.push((arguments[i__9332__auto___23920]));

var G__23921 = (i__9332__auto___23920 + (1));
i__9332__auto___23920 = G__23921;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args23913.length)].join('')));
...
var f = (function (){var pred__23916 = cljs.core._EQ_;
var expr__23917 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__23916.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__23917))){
return ((function (pred__23916,expr__23917){
return (function (p1__23909_SHARP_){
return console.warn(p1__23909_SHARP_);
});
;})(pred__23916,expr__23917))
} else {
if(cljs.core.truth_(pred__23916.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__23917))){
return ((function (pred__23916,expr__23917){
return (function (p1__23910_SHARP_){
return console.debug(p1__23910_SHARP_);
});
;})(pred__23916,expr__23917))
} else {
if(cljs.core.truth_(pred__23916.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__23917))){
return ((function (pred__23916,expr__23917){
return (function (p1__23911_SHARP_){
return console.error(p1__23911_SHARP_);
});
;})(pred__23916,expr__23917))
} else {
return ((function (pred__23916,expr__23917){
return (function (p1__23912_SHARP_){
return console.log(p1__23912_SHARP_);
});
;})(pred__23916,expr__23917))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__23940){
var map__23948 = p__23940;
var map__23948__$1 = ((((!((map__23948 == null)))?((((map__23948.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23948.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23948):map__23948);
var opts = map__23948__$1;
var eval_fn = cljs.core.get.call(null,map__23948__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__23967_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__23984,(0),null);
var v = cljs.core.nth.call(null,vec__23984,(1),null);
...
var args23987 = [];
var len__9331__auto___23991 = arguments.length;
var i__9332__auto___23992 = (0);
while(true){
if((i__9332__auto___23992 < len__9331__auto___23991)){
args23987.push((arguments[i__9332__auto___23992]));

var G__23993 = (i__9332__auto___23992 + (1));
i__9332__auto___23992 = G__23993;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args23987.length)].join('')));
...
if(cljs.core.truth_((function (){var and__8098__auto__ = typeof localStorage !== 'undefined';
